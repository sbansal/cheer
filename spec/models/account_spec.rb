...
RSpec.describe Account, type: :model do
  ...
  it 'has assets_trend' do
    ...
    sba = create(:bank_account, created_at: time_in_past, account_type: 'depository', user: shubham)
    ...
    dba = create(:bank_account, created_at: time_in_past, account_type: 'depository', user: deepti)
